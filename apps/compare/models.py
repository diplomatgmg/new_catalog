...
class CPUComparison(BaseComparison):
    products = models.ManyToManyField('product.CPUModel', verbose_name='Процессоры', related_name='compare_cpu')
...
class GPUComparison(BaseComparison):
    products = models.ManyToManyField('product.GPUModel', verbose_name='Процессоры', related_name='compare_gpu')
